...
export default Vue.extend({
  ...
  setup() {
    ...
    const addA = () => (movieName.value = movieName.value + " a");

    return { movieName, country, nameAndCountry, addA };
  }
});
</script>
...
<template>
  <div class="card">
    <div class="image">
      <img
        src="http://sp2.cinedor.es/821/cartel-relatos-salvajes-2-617.jpg"
        alt=""
      />
    </div>
    <div class="info">
      <h3 class="title">Relatos salvajes</h3>
      <p class="description">
